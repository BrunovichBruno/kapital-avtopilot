...
POLLS = {
    "Банки и карты": {"question": "Какая карта у вас основная?",
        "options": ["Т-Банк", "Альфа-Банк", "Сбер", "Другая"]},
    "Инвестиции": {"question": "Инвестируете?",
        "options": ["Да, активно", "Планирую", "Не инвестирую", "Не доверяю"]},
    "Экономика": {"question": "Следите за курсом?",
...
def build_post_text(rewritten, telegraph_url):
    ...
    hashtags = rewritten.get("hashtags", "#КапиталНаАвтопилоте #финансы")
