...
RUBRICS = [
    {"name": "Банки и карты", "keywords": ["банк", "карт", "кэшбэк", "вклад", "счёт", "дебетов", "кредитн", "ипотек"],
     "hashtags": "#КапиталНаАвтопилоте #банки #карты #кэшбэк"},
    {"name": "Инвестиции", "keywords": ["инвестиц", "акци", "облигац", "дивиденд", "брокер", "биржа", "фонд", "портфель"],
     "hashtags": "#КапиталНаАвтопилоте #инвестиции #акции #дивиденды"},
    {"name": "Экономика", "keywords": ["рубл", "доллар", "курс", "ставк", "ЦБ", "инфляц", "ВВП", "экономик"],
     "hashtags": "#КапиталНаАвтопилоте #экономика #курс #ЦБ"},
    {"name": "Личные финансы", "keywords": ["бюджет", "накоплен", "сбережен", "расход", "доход", "зарплат", "налог"],
